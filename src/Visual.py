...
def TSNE(feat):
    ...
    tsne = manifold.TSNE(n_components=2, init='pca',perplexity=35,random_state=12)
...
def VISUAL_TSNE(data_dict,args):
    ...
    full_scene_data_sne = TSNE(full_scene_data)
    ...
    sampled_zara02_data = zara02_data.sample(n=3000, random_state=42)  # 从 "zara02" 数据中随机选择 2500 个样本
    ...
    sampled_univ_data = univ_data.sample(n=3000,random_state=42)
    ...
    plt.savefig(image_save_path + str(args.test_set) + str(args.load_model) + 'sne.png')
